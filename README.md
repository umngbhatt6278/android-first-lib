![Mondia Monsooq Sdk! Logo](docs/images/logo.svg)
...
dependencies {
    ...
    implementation 'com.mondia.monsooq.component:monsooq-sdk-android:2.1.0'
}
```
...
Add the view `com.mondia.monsooq.component.ImageCarousel` in your layout:

```xml
<com.mondia.monsooq.component.ImageCarousel
...
```
Copyright 2024 Mondia Monsooq Sdk
